...
export const MobileMenu: React.FC<props> = ({currentPath, navItems, socialLinks, isMenuOpen}) => {
  ...
  <div className="border-b border-gray-100">
    {navItems.map(({ label, path }) => (
      <a
        key={path}
        href={path}
        className={`block px-6 py-4 text-lg font-medium transition duration-300 border-b border-gray-100 last:border-b-0 ${
          currentPath === path
